...
export class ObsidianStyles extends AssetLoader {
  ...
  static readonly obsidianStyleAlwaysFilter = [ "cm-", "cm6", "workspace-", ":root", "CodeMirror", "xfa", "modal", "@-webkit", "leaf", "plugins", "-split", "empty-state", "search-result-", "mobile", "tablet", "phone", "linux", "macos", "mod-windows", "is-frameless" ];
  static readonly obsidianStylesFilter = [ "ghost",
    "pdf",
    "annotation",
    "data-main-rotation",
    "spread",
