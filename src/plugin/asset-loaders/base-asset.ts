...
export class AssetLoader extends Attachment {
  ...
  public static typeToDir(type: AssetType): Path {
	...
	public static extensionToType(extension: string): AssetType {
		...
		if (mediaTypes.includes(extension)) return AssetType.Media;
		if (scriptTypes.includes(extension)) return AssetType.Script;
		if (styleTypes.includes(extension)) return AssetType.Style;
		if (htmlTypes.includes(extension)) return AssetType.HTML;
		if (fontTypes.includes(extension)) return AssetType.Font;
